...
public class QuoteCursorAdapter extends CursorRecyclerViewAdapter<QuoteCursorAdapter.ViewHolder>
  ...
  public void onBindViewHolder(final ViewHolder viewHolder, final Cursor cursor){
    ...
    viewHolder.symbol.setContentDescription(mContext.getString(R.string.symbol_desc, symbol));

    String bidprice = cursor.getString(cursor.getColumnIndex("bid_price"));
    viewHolder.bidPrice.setText(bidprice);
    viewHolder.bidPrice.setContentDescription(mContext.getString(R.string.bid_price_desc,bidprice));
    ...
    if (Utils.showPercent){
      ...
      viewHolder.change.setContentDescription(mContext.getString(R.string.change_desc,change));
